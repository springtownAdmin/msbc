                ...
                {files.length ? (<div className="flex gap-3 flex-wrap">
                        {files.map((file, i) => (
                            ...
                            <div className='flex justify-between items-center p-2 bg-white w-full'>
                                <div className='text-sm w-full truncate font-medium'>{file.file_name}</div>
                    ...
                    <div className='w-full flex justify-center items-center h-full'>No files available.</div>
                )}
              </div>
            </div>
          </div>
